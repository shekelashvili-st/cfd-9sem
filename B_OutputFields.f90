Subroutine B_OutputFields(IO,NI,NJ,X,Y,P,V,GradP,GradP_res,divV,divV_res,lapP,lapP_res,divVP,divVP_res,curlV,curlV_res)
  Real,Dimension(NI,NJ):: X,Y
  Real,Dimension(0:NI,0:NJ)::P,divV,divV_res,lapP,lapP_res,divVP,divVP_res,curlV,curlV_res
  ...
  varss = varss // '"GradPY_res", "DivV", "DivV_res", "LapP", "LapP_res", "DivVP", "DivVP_res", "curlV", "curlV_res"'
  Write(IO,*) varss
