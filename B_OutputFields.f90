Subroutine B_OutputFields(IO,NI,NJ,X,Y,P,V,GradP,GradP_res,divV,divV_res,lapP,lapP_res,divVP,divVP_res,curlV,curlV_res,T)
  ...
  Write(IO,'(100F15.7)') GradP_res(1:NI-1,1:NJ-1,1)
  Write(IO,'(100F15.7)') GradP_res(1:NI-1,1:NJ-1,2)
  Write(IO,'(100F15.7)') divV(1:NI-1,1:NJ-1)
  Write(IO,'(100F15.7)') divV_res(1:NI-1,1:NJ-1)
  Write(IO,'(100F15.7)') lapP(1:NI-1,1:NJ-1)
  Write(IO,'(100F15.7)') lapP_res(1:NI-1,1:NJ-1)
  Write(IO,'(100F15.7)') divVP(1:NI-1,1:NJ-1)
  Write(IO,'(100F15.7)') divVP_res(1:NI-1,1:NJ-1)
  Write(IO,'(100F15.7)') curlV(1:NI-1,1:NJ-1)
  Write(IO,'(100F15.7)') curlV_res(1:NI-1,1:NJ-1)
  Write(IO,'(100F15.7)') T(1:NI-1,1:NJ-1)
